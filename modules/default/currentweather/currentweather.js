...
Module.register("currentweather", {
  ...
  getDom: function() {
    ...
    temperature.innerHTML =
      " " +
      this.temperature.replace(".", this.config.decimalSymbol) +
      degreeLabel;
    ...
    if (this.config.showIndoorTemperature && this.indoorTemperature) {
      ...
      indoorTemperatureElem.innerHTML =
        " " +
        this.indoorTemperature.replace(".", this.config.decimalSymbol) +
        degreeLabel;
    ...
    if (this.config.showFeelsLike && this.config.onlyTemp === false) {
      ...
      feelsLike.innerHTML =
        this.translate("체감온도") + " " + this.feelsLike + degreeLabel;
  ...
  processWeather: function(data) {
    ...
    if (this.config.useBeaufort) {
      ...
      this.windSpeed = parseFloat((data.wind.speed * 60 * 60) / 1000).toFixed(
        0
      );
    } else {
